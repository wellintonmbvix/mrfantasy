inherited fCartoes: TfCartoes
  ...
  inherited pnlDados: TPanel
    ...
    object ledt_idcartao: TLabeledEdit
      Left = 19
      Top = 24
      Width = 70
      Height = 24
    ...
    object jvce_idcliente: TJvComboEdit
      Left = 216
      Top = 24
      Width = 81
      Height = 24
      ...
      TabOrder = 2
      Text = ''
      OnButtonClick = jvce_idclienteButtonClick
      OnChange = jvce_idclienteChange
      NumbersOnly = True
    end
    ...
    object jvspe_parcela: TJvSpinEdit
      Left = 19
      Top = 85
      Width = 70
      Height = 24
    ...
    object jvspe_parcelas: TJvSpinEdit
      Left = 95
      Top = 85
      Width = 70
      Height = 24
    ...
    object jvve_valor: TJvValidateEdit
      Left = 292
      Top = 85
      Width = 77
      Height = 24
      ...
      EditText = '0,00'
      TabOrder = 7
      OnChange = jvve_valorChange
      OnClick = jvve_valorClick
      OnEnter = jvve_valorEnter
    end
