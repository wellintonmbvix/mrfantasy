object fOrdens: TfOrdens
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.CreateDate = 44950.968147789400000000
    ReportOptions.LastChange = 44983.730522118060000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo7: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'CONTROLE INTERNO N'#186': [<frxDBCab."controle">]')
          ParentFont = False
        end
        ...
        object Memo8: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'Emiss'#227'o: [<frxDBCab."dtdocumento">]')
          ParentFont = False
        end
        ...
        object Memo10: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'Devolu'#231#227'o: [<frxDBCab."dtdevolucao">]')
          ParentFont = False
        end
        ...
        object Memo12: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Cliente: [<frxDBCab."cliente">] CPF: [<frxDBCab."cpf">] RG: [<fr' +
              'xDBCab."rg">] Tel.: [<frxDBCab."fone1">]/[<frxDBCab."fone2">]')
          Formats = <
            item
            end
            item
        ...
        object Memo13: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'End.: [<frxDBCab."endereco">], [<frxDBCab."nro">], [<frxDBCab."b' +
              'airro">] - [<frxDBCab."cidade">] / [<frxDBCab."uf">]')
        end
